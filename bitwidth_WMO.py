...
if __name__ == "__main__":
    try:
        ...
        generate_llama_cpp_config(lim_bit_widths, 'final_results/lim_revised.json')

        # Process zd_scores.json
        zd_scores = load_zd_scores('zd_scores.json')
        zd_bit_widths = assign_bit_widths_zd(zd_scores)
        generate_llama_cpp_config(zd_bit_widths, 'final_results/zd_revised.json')
        ...
        generate_llama_cpp_config(imp_bit_widths, 'final_results/baq_revised.json')

        # Generate CSV
        generate_csv_output(lim_bit_widths, zd_bit_widths, imp_bit_widths, 'final_results/quantization_comparison_revised.csv')
        print("Generated lim_revised.json, zd_revised.json, baq_revised.json, and quantization_comparison_revised.csv.")
