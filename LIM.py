...
local_path = hf_hub_download(repo_id=MODEL_ID, filename=SHARD_FILENAME, resume_download=True)
print(f"LOG_MAIN: Shard {SHARD_FILENAME} downloaded at {local_path}")
